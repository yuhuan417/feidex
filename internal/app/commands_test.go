...
func TestIsLocalCommand(t *testing.T) {
	cases := map[string]bool{
		...
		"/model plan":                true,
		"/model plan set gpt-5":      true,
		"/model plan set default":    true,
		"/model plan effort high":    true,
		"/model plan effort default": true,
		"/effort":                    true,
		"/effort high":               true,
		"/effort default":            true,
		"/quiet":                     true,
		...
		"/model plan set":                                                              false,
		"/model plan effort":                                                           false,
...
func TestIsLocalCommandForClaudeBackend(t *testing.T) {
	cases := map[string]bool{
		...
		"/plan off":                          false,
		"/goal":                              false,
		"/goal improve benchmark coverage":   false,
		"/model plan":                        false,
		"/model plan set gpt-5":              false,
		"/thread":                            false,
		"/thread list":                       false,
