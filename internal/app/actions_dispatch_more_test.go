...
func TestDispatchCardActionRoutesCommonBranches(t *testing.T) {
	...
	cases := []feishu.CardAction{
		...
		{ActionValue: map[string]any{"action": "menu.download", "session_key": "sess-1", "parent_action": "menu.tools"}, UserID: "user-1", ChatID: "chat-1", MessageID: "msg-1"},
		{ActionValue: map[string]any{"action": "menu.fork", "session_key": "sess-1", "parent_action": "menu.thread"}, UserID: "user-1", ChatID: "chat-1"},
		{ActionValue: map[string]any{"action": "menu.compact", "session_key": "sess-2", "parent_action": "menu.tools"}, UserID: "user-1", ChatID: "chat-1"},
		...
		{ActionValue: map[string]any{"action": "thread.resume.select", "session_key": "sess-1"}, Option: "thread-2", UserID: "user-1", ChatID: "chat-1"},
		{ActionValue: map[string]any{"action": "history.detail", "session_key": "sess-1", "index": float64(0)}, UserID: "user-1", ChatID: "chat-1"},
		{ActionValue: map[string]any{"action": "history.detail.select", "session_key": "sess-1"}, Option: "0", UserID: "user-1", ChatID: "chat-1"},
