...
var registry = []Spec{
	...
	},
	{
		...
		Kind: SpecKindCapability,
		Commands: []CommandSpec{
			{ID: "model", Names: []string{"/model"}, HelpGroup: "model", HelpEntries: []HelpCommandSpec{{Command: "/model", Summary: "打开主模型配置和辅助模型摘要。"}, {Command: "/model set <model-id>", Summary: "直接设置 Bot 默认 model。"}, {Command: "/model effort <effort>", Summary: "直接设置 Bot 默认推理强度。"}, {Command: "/model plan set <model-id|default>", Summary: "设置 Codex Plan 模型。"}, {Command: "/model plan effort <effort|default>", Summary: "设置 Codex Plan 推理强度。"}, {Command: "/model review set <model-id|default>", Summary: "设置 Codex review 模型。"}, {Command: "/model subagent set <model-id|default>", Summary: "设置子 agent 模型。"}, {Command: "/model subagent effort <effort|default>", Summary: "设置 Codex 子 agent 推理强度。"}}, Backends: map[string]CommandBackendSpec{appruntime.BackendClaude: {HelpEntries: []HelpCommandSpec{{Command: "/model", Summary: "打开主模型配置和辅助模型摘要。"}, {Command: "/model small set <model-id|default>", Summary: "设置 Claude small model。"}, {Command: "/model subagent set <model-id|default>", Summary: "设置 Claude subagent model。"}, {Command: "/model option add <model-id>", Summary: "把 model id 加入 Claude 模型选择下拉框。"}, {Command: "/model option remove <model-id>", Summary: "从 Claude 模型选择下拉框移除候选 model。"}}}}},
