...
var registry = []Spec{
	...
	},
	{
		...
		Kind: SpecKindCapability,
		Commands: []CommandSpec{
			{ID: "model", Names: []string{"/model"}, HelpGroup: "model", HelpEntries: []HelpCommandSpec{{Command: "/model", Summary: "打开模型选择与推理强度配置。"}, {Command: "/model set <model-id>", Summary: "直接设置 Bot 默认 model。"}, {Command: "/model set default", Summary: "恢复 Bot 默认 model。"}, {Command: "/model effort <effort>", Summary: "直接设置 Bot 默认推理强度。"}, {Command: "/model effort default", Summary: "恢复默认推理强度。"}, {Command: "/model plan", Summary: "查看 Plan 模式的独立模型配置。"}, {Command: "/model plan set <model-id>", Summary: "直接设置 Plan 模式模型。"}, {Command: "/model plan set default", Summary: "让 Plan 模式模型恢复跟随 default mode。"}, {Command: "/model plan effort <effort>", Summary: "直接设置 Plan 模式推理强度。"}, {Command: "/model plan effort default", Summary: "让 Plan 模式推理强度恢复跟随 plan preset。"}}, Backends: map[string]CommandBackendSpec{appruntime.BackendClaude: {HelpEntries: []HelpCommandSpec{{Command: "/model", Summary: "打开模型选择与推理强度配置。"}, {Command: "/model set <model-id>", Summary: "直接设置 Bot 默认 model。"}, {Command: "/model set default", Summary: "恢复 Bot 默认 model。"}, {Command: "/model effort <effort>", Summary: "直接设置 Bot 默认推理强度。"}, {Command: "/model effort default", Summary: "恢复默认推理强度。"}, {Command: "/model option add <model-id>", Summary: "把 model id 加入 Claude 模型选择下拉框。"}, {Command: "/model option remove <model-id>", Summary: "从 Claude 模型选择下拉框移除候选 model。"}}}}},
