...
type conversationBackendFacade interface {
	...
	startQueuedSubmission(w *submissionWorkflow, sessionKey string, sess *state.Session, sub *state.Submission, ws *config.Workspace, notifyFailure bool) error
}
...
func (b codexConversationBackend) startQueuedSubmission(w *submissionWorkflow, sessionKey string, sess *state.Session, sub *state.Submission, ws *config.Workspace, notifyFailure bool) error {
...
func (b claudeConversationBackend) startQueuedSubmission(w *submissionWorkflow, sessionKey string, sess *state.Session, sub *state.Submission, ws *config.Workspace, notifyFailure bool) error {
